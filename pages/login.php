...
.body{
	...
	width: auto;
	height: auto;
	background-image: url("./themes/default/img/login_background.jpg");
...
<body>
  ...
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<img src="./themes/default/img/logo.png" alt="HandySan" height="100dp" width="280dp">
		...
		<div class="login">
			...
			<?php 
				...
				if(isset($message) & $message != ""){
					echo "<div id=\"message\" style=\"margin-top: 7%; background: red; width: 64%; padding: 1% 5% 1%; opacity: 0.8; border: 1px solid red; border-radius: 2px;\">
				<P>".$message."</P>
				</div>";
				} 
			?>
